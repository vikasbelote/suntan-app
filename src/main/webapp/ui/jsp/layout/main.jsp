...
<head>
	...
	<link href="../ui/assets/plugins/jquery-jvectormap/jquery-jvectormap.css" rel="stylesheet" />
	<link href="../ui/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" />
    <link href="../ui/assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" />
...
<body>
			...
			<ul class="navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu media-list dropdown-menu-right">
						...
						<li class="media">
							<a href="javascript:;">
								<div class="media-left">
									<img src="../ui/assets/img/user/user-1.jpg" class="media-object" alt="" />
						...
						<li class="media">
							<a href="javascript:;">
								<div class="media-left">
									<img src="../ui/assets/img/user/user-2.jpg" class="media-object" alt="" />
									<i class="fab fa-facebook-messenger text-primary media-object-icon"></i>
								</div>
								<div class="media-body">
				...
				<li class="dropdown navbar-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
						<img src="../ui/assets/img/user/user-13.jpg" alt="" /> 
				...
				<ul class="nav">
					...
					<li>
						<a href="bootstrap_4.html">
							<div class="icon-img">
						    	<img src="../ui/assets/img/logo/logo-bs4.png" alt="" />
						    </div>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
						    <li><a href="../ui/../ui/../ui/frontend/template/template_one_page_parallax/index.html" target="_blank">One Page Parallax</a></li>
						    <li><a href="../ui/../ui/../ui/frontend/template/template_blog/index.html" target="_blank">Blog</a></li>
						    <li><a href="../ui/../ui/../ui/frontend/template/template_forum/index.html" target="_blank">Forum</a></li>
						    <li><a href="../ui/../ui/../ui/frontend/template/template_e_commerce/index.html" target="_blank">E-Commerce</a></li>
						</ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="../ui/template_ajax/index.html">AJAX</a></li>
					        <li><a href="../ui/template_angularjs/index.html">ANGULAR JS</a></li>
					        <li><a href="../ui/template_angularjs5/index.html">ANGULAR JS 5 <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					        <li><a href="../ui/template_laravel/index.html">LARAVEL <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					        <li><a href="../ui/template_material/index.html">MATERIAL DESIGN</a></li>
					        <li><a href="../ui/template_apple/index.html">APPLE DESIGN</a></li>
					        <li><a href="../ui/template_transparent/index.html">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
								...
								<ul class="media-list media-list-with-divider">
									<li class="media media-lg">
										<a href="javascript:;" class="pull-left">
											<img class="media-object" src="../ui/assets/img/gallery/gallery-1.jpg" alt="" />
										</a>
										<div class="media-body">
									...
									<li class="media media-lg">
										<a href="javascript:;" class="pull-left">
											<img class="media-object" src="../ui/assets/img/gallery/gallery-10.jpg" alt="" />
										</a>
										<div class="media-body">
									...
									<li class="media media-lg">
										<a href="javascript:;" class="pull-left">
											<img class="media-object" src="../ui/assets/img/gallery/gallery-7.jpg" alt="" />
										</a>
										<div class="media-body">
									...
									<li class="media media-lg">
										<a href="javascript:;" class="pull-left">
											<img class="media-object" src="../ui/assets/img/gallery/gallery-8.jpg" alt="" />
										</a>
										<div class="media-body">
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td class="hidden-sm">
												<a href="javascript:;">
													<img src="../ui/assets/img/product/product-1.png" alt=""  />
												</a>
											</td>
										...
										<tr>
											...
											<td class="hidden-sm">
												<a href="javascript:;">
													<img src="../ui/assets/img/product/product-2.png" alt="" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-sm">
												<a href="javascript:;">
													<img src="../ui/assets/img/product/product-3.png" alt="" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-sm">
												<a href="javascript:;">
													<img src="../ui/assets/img/product/product-4.png" alt="" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-tablet hidden-phone">
												<a href="javascript:;">
													<img src="../ui/assets/img/product/product-5.png" alt="" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
							...
							<div class="height-sm" data-scrollbar="true">
								<ul class="media-list media-list-with-divider">
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-1.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-2.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-3.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-4.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
						...
						<div class="panel-body">
							<div class="height-sm" data-scrollbar="true">
								<ul class="media-list media-list-with-divider media-messaging">
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-5.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-6.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-8.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
									...
									<li class="media media-sm">
										<a href="javascript:;" class="pull-left">
											<img src="../ui/assets/img/user/user-7.jpg" alt="" class="media-object rounded-corner" />
										</a>
										<div class="media-body">
											<h5 class="media-heading">John Doe</h5>
        ...
        <div class="theme-panel">
            ...
            <div class="theme-panel-content">
                ...
                <ul class="theme-list clearfix">
                    <li class="active"><a href="javascript:;" class="bg-green" data-theme="default" data-theme-file="../ui/assets/css/default/theme/default.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Default">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-red" data-theme="red" data-theme-file="../ui/assets/css/default/theme/red.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-blue" data-theme="blue" data-theme-file="../ui/assets/css/default/theme/blue.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Blue">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-purple" data-theme="purple" data-theme-file="../ui/assets/css/default/theme/purple.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Purple">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-orange" data-theme="orange" data-theme-file="../ui/assets/css/default/theme/orange.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Orange">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-black" data-theme="black" data-theme-file="../ui/assets/css/default/theme/black.css" data-click="theme-selector" data-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Black">&nbsp;</a></li>
                </ul>
	...
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
	<script src="../ui/assets/plugins/gritter/js/jquery.gritter.js"></script>
	<script src="../ui/assets/plugins/flot/jquery.flot.min.js"></script>
	<script src="../ui/assets/plugins/flot/jquery.flot.time.min.js"></script>
	<script src="../ui/assets/plugins/flot/jquery.flot.resize.min.js"></script>
	<script src="../ui/assets/plugins/flot/jquery.flot.pie.min.js"></script>
	<script src="../ui/assets/plugins/sparkline/jquery.sparkline.js"></script>
	<script src="../ui/assets/plugins/jquery-jvectormap/jquery-jvectormap.min.js"></script>
	<script src="../ui/assets/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script src="../ui/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script src="../ui/assets/js/demo/dashboard.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
